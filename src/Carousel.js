...
const Carousel = ({ images }) => {
    ...
    const handleNext = () => {
        setCurrentIndex((prevIndex) => prevIndex + 2 === images.length ? 1 : prevIndex + 1)
    }

    const handlePrevious = () => {
        setCurrentIndex((prevIndex) => prevIndex - 2 < 0 ? images.length - 2 : prevIndex - 2)
    }
            ...
            <div className='slide-direction'>
                <div className='left' onClick={handlePrevious}>
                    <svg xmlns='http://www.w3.org/2000/svg' height='20' width='20' viewBox='0 96 960 960'>
                        <path d='M400 976 0 5761400-400 56 57-343 343 343 343-56 57Z' />
                    </svg>
                </div>
